...
patient['dob'] = pd.to_datetime(patient['dob'], format='get_ipython().run_line_magic("m%d%y')", "    # 1")
patient['deceaseddate'] = pd.to_datetime(patient['deceaseddate'], format='get_ipython().run_line_magic("m%d%y')", "")
