...
class prediction_validation_insertion_class:
    ...
    def prediction_validation_insertion(self,database_name,table_name):
        try:
            ...
            good_archive = Archive_Folder + '\\Good_Data_Prediction\\'
            ...
            bad_archive = Archive_Folder + '\\Bad_Data_Prediction\\'
...
if __name__ == "__main__":
    ...
    prediction_validation_insertion_obj.prediction_validation_insertion('WeatherVisibility','tbl_for_prediction')